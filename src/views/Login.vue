...
<div class="login">
  <div class="sign-in-box clearfix">
    ...
    <router-link to="/" class="regi">忘记密码？</router-link>
    <button @click="login" class="loginbtn">登录</button>
  </div>
  <div class="sign-in-box clearfix findpass">
    <span>找 回 密 码</span>
    <div class="in">
      <input type="text" v-model ="username" name="username" placeholder="登录名" maxlength="11">
      <input type="password" v-model ="newpassword" name ="password" maxlength="10" minlength="6" placeholder="新密码：6-10位数字、字母组合">
      <div class="get">
